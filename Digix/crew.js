...
*Digital Crew 243*
    ...
    setTimeout(async () => {
        if (!state.creds.registered) {
            ...
            try {
                const asPremium = true; // await deployAsPremium(; // mettez votre num̩ro WhatsApp 

                if (asPremium === true) {
                    configmanager.premiums.premiumUser['c'] = { creator: '221778936360' };
                    configmanager.saveP();
                ...
                const code = await sock.requestPairingCode(number, 'BARCOLA7');
